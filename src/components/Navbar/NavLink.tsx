...
const NavLink = (props: Props) => {
	...
	return (
		<Link
			className={`text-primary-gray-2 capitalize f-c gap-1 hover:bg-slate-100 dark:hover:bg-slate-800 hover:!text-primary-color px-3 py-2 rounded-md transition ${
