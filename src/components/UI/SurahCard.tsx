...
const SurahCard = (props: PropsType) => {
	...
	return (
		<div className="w-full py-6 bg-white dark:bg-slate-900 px-4 rounded-lg drop-shadow-sm border border-transparent dark:border-slate-800 transition-colors duration-200">
			...
			>
				<h3 className="text-end text-xl text-primary-gray dark:text-slate-200 amiri-family">
					{name}
				</h3>
				<h4 className="text-start text-lg text-primary-gray-2 dark:text-slate-400">
					{englishName}
				</h4>
			</Link>
		</div>
